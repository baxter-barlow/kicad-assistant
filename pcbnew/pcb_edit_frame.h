...
#include "../kicad/assistant_panel.h"
 ...
 */
class PCB_EDIT_FRAME : public PCB_BASE_EDIT_FRAME, public ASSISTANT_PANEL_HOST
{
public:
    ...
    static const wxString AssistantPaneName() { return wxT( "AssistantPanel" ); }
     ...
     */
    void SetActiveLayer( PCB_LAYER_ID aLayer ) override { SetActiveLayer( aLayer, false ); }
    ...
    bool                    IsAssistantPaneShown() { return m_auimgr.GetPane( AssistantPaneName() ).IsShown(); }
    ASSISTANT_PANEL_CONTEXT GetAssistantPanelContext() const override;
    void                    FocusSearch();
     ...
     */
    int DoGenFootprintsPositionFile( const wxString& aFullFileName, bool aUnitsMM, bool aOnlySMD, bool aNoTHItems,
     ...
     * @return true if Ok.
     */
    bool ExportVRML_File( const wxString& aFullFileName, double aMMtoWRMLunit, bool aIncludeUnspecified,
                          bool aIncludeDNP, bool aExport3DFiles, bool aUseRelativePaths, const wxString& a3D_Subdir,
     ...
     */
    void ExchangeFootprint( FOOTPRINT* aExisting, FOOTPRINT* aNew, BOARD_COMMIT& aCommit, bool matchPadPositions,
                            bool deleteExtraTexts = true, bool resetTextLayers = true, bool resetTextEffects = true,
                            bool resetTextPositions = true, bool resetTextContent = true,
                            bool resetFabricationAttrs = true, bool resetClearanceOverrides = true,
...
public:
    ...
    bool m_ShowSearch;
    bool m_ShowAssistantPanel;
    bool m_ShowNetInspector;
    int  m_AssistantPanelWidth;
...
private:
    ...
    ASSISTANT_PANEL*           m_assistantPanel;
