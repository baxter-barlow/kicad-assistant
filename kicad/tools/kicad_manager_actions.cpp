...
TOOL_ACTION
KICAD_MANAGER_ACTIONS::newProject( TOOL_ACTION_ARGS()
...
TOOL_ACTION
KICAD_MANAGER_ACTIONS::viewDroppedGerbers( TOOL_ACTION_ARGS()
...
TOOL_ACTION KICAD_MANAGER_ACTIONS::convertImage(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION KICAD_MANAGER_ACTIONS::showCalculator(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION
KICAD_MANAGER_ACTIONS::editDrawingSheet( TOOL_ACTION_ARGS()
...
TOOL_ACTION KICAD_MANAGER_ACTIONS::restoreLocalHistory(
        TOOL_ACTION_ARGS()
