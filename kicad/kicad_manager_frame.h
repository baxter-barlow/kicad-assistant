 ...
 */
class KICAD_MANAGER_FRAME : public EDA_BASE_FRAME, public ASSISTANT_PANEL_HOST
{
public:
    ...
    */
    void ImportNonKiCadProject( const wxString& aWindowTitle, const wxString& aFilesWildcard,
                                ...
                                const std::vector<std::string>& aPcbFileExtensions, int aSchFileType,
                                int aPcbFileType );
