        ...
        wxAuiDefaultDockArt()
{
    ...
    // Dark pane chrome to match the assistant panel color scheme
    if( KIPLATFORM::UI::IsDarkTheme() )
    {
        wxColour bg( 0x1b, 0x1d, 0x23 );
        wxColour surface( 0x22, 0x24, 0x30 );
        wxColour border( 0x2e, 0x32, 0x44 );

        SetColour( wxAUI_DOCKART_BACKGROUND_COLOUR, bg );
        SetColour( wxAUI_DOCKART_SASH_COLOUR, border );
        SetColour( wxAUI_DOCKART_BORDER_COLOUR, border );
        SetColour( wxAUI_DOCKART_GRIPPER_COLOUR, surface );
        SetColour( wxAUI_DOCKART_ACTIVE_CAPTION_COLOUR, surface );
        SetColour( wxAUI_DOCKART_INACTIVE_CAPTION_COLOUR, surface );
        SetColour( wxAUI_DOCKART_ACTIVE_CAPTION_TEXT_COLOUR, wxColour( 0xd4, 0xd8, 0xe8 ) );
        SetColour( wxAUI_DOCKART_INACTIVE_CAPTION_TEXT_COLOUR, wxColour( 0x8c, 0x92, 0xa8 ) );
