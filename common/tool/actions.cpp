...
TOOL_ACTION
        ACTIONS::selectItem( TOOL_ACTION_ARGS().Name( "common.InteractiveSelection.selectItem" ).Scope( AS_GLOBAL ) );

TOOL_ACTION
        ACTIONS::selectItems( TOOL_ACTION_ARGS().Name( "common.InteractiveSelection.selectItems" ).Scope( AS_GLOBAL ) );

TOOL_ACTION ACTIONS::unselectItem(
        TOOL_ACTION_ARGS().Name( "common.InteractiveSelection.unselectItem" ).Scope( AS_GLOBAL ) );

TOOL_ACTION ACTIONS::unselectItems(
        TOOL_ACTION_ARGS().Name( "common.InteractiveSelection.unselectItems" ).Scope( AS_GLOBAL ) );

TOOL_ACTION ACTIONS::reselectItem(
        TOOL_ACTION_ARGS().Name( "common.InteractiveSelection.reselectItem" ).Scope( AS_GLOBAL ) );

TOOL_ACTION
        ACTIONS::selectionClear( TOOL_ACTION_ARGS().Name( "common.InteractiveSelection.clear" ).Scope( AS_GLOBAL ) );

TOOL_ACTION ACTIONS::selectionMenu(
        TOOL_ACTION_ARGS().Name( "common.InteractiveSelection.selectionMenu" ).Scope( AS_GLOBAL ) );


// Group actions
TOOL_ACTION
        ACTIONS::group( TOOL_ACTION_ARGS()
...
// GROUP_TOOL
TOOL_ACTION ACTIONS::groupProperties( TOOL_ACTION_ARGS().Name( "common.Groups.groupProperties" ).Scope( AS_GLOBAL ) );

TOOL_ACTION ACTIONS::pickNewGroupMember(
        TOOL_ACTION_ARGS().Name( "common.Groups.selectNewGroupMember" ).Scope( AS_GLOBAL ) );
...
TOOL_ACTION
        ACTIONS::doDelete( TOOL_ACTION_ARGS()
...
TOOL_ACTION
        ACTIONS::incrementSecondary( TOOL_ACTION_ARGS()
...
TOOL_ACTION
        ACTIONS::decrementSecondary( TOOL_ACTION_ARGS()
...
TOOL_ACTION
        ACTIONS::selectRows( TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::exportTableCSV(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::pointEditorArcKeepCenter(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::pointEditorArcKeepEndpoint(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::pointEditorArcKeepRadius(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::showAssistantPanel( TOOL_ACTION_ARGS()
                                                 .Name( "common.Interactive.assistantPanel" )
                                                 .Scope( AS_GLOBAL )
                                                 .FriendlyName( _( "Assistant" ) )
                                                 .Tooltip( _( "Show or hide the assistant panel" ) )
                                                 .Icon( BITMAPS::find ) );
...
TOOL_ACTION ACTIONS::centerContents( TOOL_ACTION_ARGS().Name( "common.Control.centerContents" ).Scope( AS_GLOBAL ) );
...
TOOL_ACTION ACTIONS::toggleGridOverrides(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::cursorFullCrosshairs(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::cursor45Crosshairs(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::measureTool(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION
        ACTIONS::showFootprintLibTable( TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::showDesignBlockLibTable(
        TOOL_ACTION_ARGS()
...
TOOL_ACTION ACTIONS::ddAddLibrary( TOOL_ACTION_ARGS().Name( "common.Control.ddaddLibrary" ).Scope( AS_GLOBAL ) );
...
const TOOL_EVENT EVENTS::GridChangedByKeyEvent( TC_MESSAGE, TA_ACTION, "common.Interactive.gridChangedByKey" );
